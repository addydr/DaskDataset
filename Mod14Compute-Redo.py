...
with ProgressBar():
 print('Weapon Desc & Vict Age','Min Avg Rating\n',df.groupby(['Weapon Desc'])['Vict Age'].min().compute())

 print('Weapon Desc & Vict Age','Max Avg Rating\n',df.groupby(['Weapon Desc'])['Vict Age'].max().compute())

 print('Weapon Desc & Vict Age','Mean Avg Rating\n',df.groupby(['Weapon Desc'])['Vict Age'].mean().compute())
